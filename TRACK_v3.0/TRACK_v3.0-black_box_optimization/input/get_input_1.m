%%
% Copied from get_input_4.m, with long track
% For the simulation of plain track dynamics
%%
function [in_data] = get_input_1(in_data)
%%
%Geometry input
...
in_data.mesh.m_1S_Int=4;                %Number of elements in a sleeper internal
